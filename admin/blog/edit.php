...
if (isset($_POST['blogPostMarkup'])) {
    ...
    if (isset($_FILES['blogPostThumbnail'])) {
        ...
        move_uploaded_file($_FILES['blogPostThumbnail']['tmp_name'], pathOf("assets/uploads/blog-thumbnails/$thumbnailFileName"));
...
$thumbnailFileName = $row['ThumbnailFileName'] != null ? urlOf('assets/uploads/blog-thumbnails/' . $row['ThumbnailFileName']) : urlOf('assets/images/borders.png');
